...
@available(iOS 13.0, *)
public class DirectoryChangeWatcher: NSObject, NSFilePresenter, ObservableObject {
...
extension DirectoryChangeWatcher {
     ...
     */
    public func relinquishPresentedItem(toReader reader: @escaping @Sendable ((() -> Void)?) -> Void) {
     ...
     */
    public func relinquishPresentedItem(toWriter writer: @escaping @Sendable ((() -> Void)?) -> Void) {
